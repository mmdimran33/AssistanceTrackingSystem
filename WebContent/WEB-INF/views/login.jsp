...
<body class="bg-dark">
		...
		<div class="card card-login mx-auto mt-5">
				...
				<form:form action="login1.html" method="post"
					...
					<div class="form-group">
						...
						<form:input path="userName" class="form-control" id="userName"
							type="text" aria-describedby="userName" placeholder="UserName" />
						<span id="nameErr"></span>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Password</label>
						<!--<input class="form-control" id="exampleInputEmail1" type="UserName" aria-describedby="emailHelp" placeholder="UserName">-->
						<form:input path="userPassword" class="form-control" id="Password"
							type="text" aria-describedby="Password" placeholder="Password" />
						<span id="pasErr"></span>
					</div>
           ...
           <form:input path="userPassword" class="control" id="userPassword" type="password" aria-describedby="Password" placeholder="Password"/>
				...
				<div class="text-center">
					<a class="d-block small mt-3" href="userregister.html">Register
						an Account</a> <a class="d-block small" href="forgotpass.html">Forgot
						Password?</a>
				</div>
			</div>
		</div>
	...
	<script
		src="<%=request.getContextPath()%>/js/boostrapjs/bootstrap.bundle.min.js"
		type="text/javascript"></script>
	<!-- Core plugin JavaScript-->
	<!-- <script src="vendor/jquery-easing/jquery.easing.min.js"></script> -->
	<script src="<%=request.getContextPath()%>/js/jquery.easing.min.js"
		type="text/javascript"></script>

	<c:set var="saveFlag" value="${actionMessage}"></c:set>
	<c:if test="${not empty saveFlag}">
		<div id="div3"
			style="width: 975px; position: absolute; top: 110px; left: 261px; height: 60px; display: none; background-color: Teal; text-align: center">
			<c:out value="${saveFlag}"></c:out>
		</div>
	</c:if>
</body>
</html>
